...
this.title = null;
this.backgroundFillStyle = 'rgba(255,255,255,0)';//背景色
this.borderStrokeStyle = 'rgba(255,255,255,0)';
this.borderWidth = 1.0;
this.labelFillStyle = 'black';//字的颜色
...
this.pieFillStyle = '#29b6f6';//环的颜色
this.pieStrokeStyle = '#fff';//环的border
this.pieBorderWidth = 1.0;
this.pieShadowColor = '#29b6f6';
this.pieShadowBlur = 5;
this.pieShadowOffsetX = 1.0;
